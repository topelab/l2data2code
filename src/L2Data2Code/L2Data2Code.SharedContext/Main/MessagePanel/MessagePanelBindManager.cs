...
{
    internal class MessagePanelBindManager : IMessagePanelChangeListener
    {
        ...
        public MessagePanelBindManager(IMessagePanelService messagePanelService, IMessageService messageService, ILogger logger)
        {
